...
def fast_count_segments(starts, ends, points):
    ...
    starts_left = [left] * len(starts)
    ends_right = [right] * len(ends)
    points_p = [point] * len(points)

    pairs_number = starts + ends + points
    pairs_letter = starts_left + ends_right + points_p
...
def less_than_or_equal(num1, num2, let1, let2):
    return less_than(num1, num2, let1, let2) or equal(num1, num2, let1, let2)
